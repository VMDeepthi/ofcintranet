    ...
    <>
      ...
      <Toolbar>
          ...
          >
            ...
            <img src='LOGO.png' alt='logo' style={{ marginTop: '5px', marginLeft: '10px', width: '90%', height: '50px' }} />
            </Link>
          </Typography>
          ...
          <Box sx={{ display: { xs: 'none', md: 'flex' } }}>
            ...
            >
              {userDetails.profile_pic === '' ? <AccountCircle sx={{ width: 35, height: 35 }}/> : <Avatar sx={{ width: 35, height: 35 }} src={userDetails.profile_pic} />}
            </IconButton>
          </Box>
