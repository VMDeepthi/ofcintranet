...
const Attendance = () => {
    ...
    const subHeaderViewCompanyMemo = React.useMemo(() => {
        ...
        return (
            ...
            <Container sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexDirection:{xs:'column',lg:'row'} }}>
                ...
                <Stack component={'form'} onSubmit={handleFilterAttendace} direction={{ xs: 'column', lg: 'row' }} spacing={2} display={'flex'} justifyContent={'center'} m={2}>
                    ...
                    <Stack direction={'row'} spacing={1}>
                        ...
                        <Fade in={data.length!==0} unmountOnExit timeout={1000} >
